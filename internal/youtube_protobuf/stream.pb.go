...
func (LiveChatMessageSnippet_TypeWrapper_Type) EnumDescriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{4, 0, 0}
}
...
func (LiveChatUserBannedMessageDetails_BanTypeWrapper_BanType) EnumDescriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{6, 0, 0}
}
...
func (LiveChatPollDetails_PollStatusWrapper_PollStatus) EnumDescriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{14, 1, 0}
}
...
func (*LiveChatMessageSnippet_TypeWrapper) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{4, 0}
}
...
func (*LiveChatUserBannedMessageDetails_BanTypeWrapper) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*LiveChatPollDetails_PollMetadata) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{14, 0}
}
...
func (*LiveChatPollDetails_PollStatusWrapper) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{14, 1}
}
...
func (*LiveChatPollDetails_PollMetadata_PollOption) Descriptor() ([]byte, []int) {
	return file_stream_proto_rawDescGZIP(), []int{14, 0, 0}
}
...
const file_stream_proto_rawDesc = "" +
	"\n" +
	"\fstream.proto\x12\x0eyoutube.api.v3\x1a\x1egoogle/protobuf/duration.proto\"\xd0\x01\n" +
	...
	"\n" +
	"StreamList\x12*.youtube.api.v3.LiveChatMessageListRequest\x1a+.youtube.api.v3.LiveChatMessageListResponse\"\x000\x01B\x14Z\x12./youtube_protobuf"
...
var file_stream_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
