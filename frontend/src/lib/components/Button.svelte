...
.btn[data-variant="surface"] {
  --_btn-bg: color-mix(in srgb, light-dark(var(--neutral-100), var(--neutral-800-tint)) 15%, transparent);
  --_btn-border: color-mix(in srgb, light-dark(var(--neutral-200), var(--neutral-700-tint)) 15%, transparent);
...
.btn[data-variant="transparent"][aria-pressed="true"] {
  ...
  --_active-border: light-dark(
    var(--neutral-200-tint),
    var(--neutral-700-tint)
  );
  --_active-color: var(--color-text);
  --_icon-color: var(--color-brand);
}
