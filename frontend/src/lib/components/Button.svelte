...
<style>
  ...
  .btn[data-variant="surface"] {
    --_btn-bg: color-mix(
      in srgb,
      light-dark(var(--neutral-100), var(--neutral-800-tint)) 15%,
      transparent
    );
    --_btn-border: color-mix(
      in srgb,
      light-dark(var(--neutral-200), var(--neutral-700-tint)) 15%,
      transparent
    );
  ...
  @media (hover: hover) {
    ...
    .btn:where([data-variant="surface"], [data-variant="transparent"]):where(
      [aria-pressed="true"]
    ):hover {
